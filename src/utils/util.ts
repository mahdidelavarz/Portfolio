...
// CurvedPlaneGeometry
class CurvedPlaneGeometry extends PlaneGeometry {
  constructor(radius: number, width: number = 1, height: number = 1, widthSegments: number = 20, heightSegments: number = 20) {
...
// SineWaveMaterial
class SineWaveMaterial extends MeshBasicMaterial {
  time: { value: number };
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      curvedPlaneGeometry: ReactThreeFiber.Node<THREE.PlaneGeometry, unknown> & {
        args?: [radius: number, width?: number, height?: number, widthSegments?: number, heightSegments?: number];
      };
      sineWaveMaterial: ReactThreeFiber.Node<THREE.MeshBasicMaterial, THREE.MeshBasicMaterialParameters> & {
        map?: THREE.Texture;
