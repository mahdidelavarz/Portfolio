...
export const metadata = {
  title: "Mahdi Delavar | Frontend Developer Portfolio - React & Next.js Expert",
  description: "Experienced Frontend Developer specializing in React, Next.js, and modern web technologies. 3+ years of experience, 50+ projects delivered. Crafting exceptional digital experiences with modern technologies.",
  keywords: [
    "Frontend Developer",
    "React Developer", 
    "Next.js Expert",
  ...
  openGraph: {
    ...
    description: "Experienced Frontend Developer specializing in React, Next.js, and modern web technologies. View my projects and experience.",
