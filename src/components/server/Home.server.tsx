...
const Home = memo(function Home({ scrollToSection }: HomeProps) {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-3 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`transition-all duration-1000 delay-300 `}>
            ...
            {/* <div className="flex items-center justify-center gap-4 mb-16">
              ...
              <span className="text-cyan-300 font-medium tracking-widest text-sm md:text-lg text-shadow-xs text-shadow-black uppercase">
                HELLO WORLD
              </span>
              <div className="w-16 h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent"></div>
            </div> */}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <a
                href="/resume.pdf" // Replace with your PDF's URL, e.g., "https://yourwebsite.com/resume.pdf"
