...
function Experiences({ scrollToSection }: ExperiencesProps) {
  ...
  const techIcons: Record<string, string> = {
    ...
    Zustand: "tabler:brand-zulip", // Zustand has no official icon, using closest
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div
            className={`relative mx-auto max-w-5xl transition-all duration-1000 delay-200`}
          >
            <div
          ...
          <div
            className={`absolute -left-55 top-0 w-72 transition-all duration-1000 delay-400 hidden xl:block`}
          >
          ...
          {/* Right Stats Panel */}
          <div
            className={`absolute -right-55 top-0 w-72 transition-all duration-1000 delay-600 hidden xl:block`}
          >
            <div className="backdrop-blur-lg bg-slate-900/40 border border-slate-700/60 rounded-2xl p-6 shadow-xl">
              <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                <Icon
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-800/30 rounded-xl border border-slate-700/30">
                  <div className="text-xl font-bold text-cyan-400 mb-1">3+</div>
