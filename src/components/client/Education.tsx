...
const ONLINE_COURSES = [
  {
    title: "JavaScript Modern Complete",
    platform: "Fronthooks.ir",
    duration: "2 months",
    completed: "2024",
    certificate: "Fronthooks Certified",
    rating: 4.9,
    description:
      "Modern JavaScript from ES6 to ES2024, covering all essential concepts and advanced features",
    skills: [
      "ES6+ Features",
      "Async/Await",
      "Closures & Scope",
  ...
  },
  {
    ...
    rating: 4.8,
    description:
      "Complete TypeScript course covering type system, advanced patterns, and real-world applications",
    skills: ["Advanced Types", "Generics", "Type Inference", "Utility Types"],
    icon: LogosTypescriptBold,
    color: "from-blue-600 to-blue-400",
  },
  {
    title: "React Mastery with Hooks",
    platform: "Fronthooks.ir",
    duration: "3 months",
    completed: "2024",
    certificate: "Fronthooks Certified",
    rating: 4.9,
    description:
      "Deep dive into React functional components, hooks, and modern React patterns",
    skills: [
      "React Hooks",
      "Custom Hooks",
      "Context API",
  ...
  },
  {
    ...
    rating: 4.9,
    description:
      "Full-stack Next.js development with App Router, Server Components, and modern deployment",
    skills: [
      "App Router",
